...
class EXP1():
    def __init__(self, args) -> None:
        ...
        #relative paths
        self.temp_dir = os.path.join(args.data_dir, "temp/exp1")
        self.exp_result_dir = os.path.join(self.results_dir, "exp1")
        self.exp_models_dir = os.path.join(self.models_dir, "exp1")
        if self.drop_all:            
        ...
        self.result_excel = os.path.join(self.exp_result_dir, "EXP1_PERFORMANCE.xlsx")
    ...
    def generate_results(self) -> None:
        ...
        print("Shape of X = {}, Shape of y = {}, Distribution = {}".format(X.shape, y.shape, Counter(y)))
